...
public class IrisMain {
    public static void main(String[] args) {
        ...
        if (args.length < 2) {
            System.out.println("Usage: java IrisMain <criterion> <maxDepth>");
        ...
        try {
            ...
            DatasetInfo datasetInfo = loader.loadDataset("Datasets/Iris.csv");
            ...
            DatasetSplit split = loader.splitDataset(datasetInfo.getSamples(), 0.8, new java.util.Random(42));
